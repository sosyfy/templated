...
function About1() {
    return (
        <section className="flex items-center py-10 overflow-x-hidden">
            <Container className="w-full py-14">
                <div className="grid items-center grid-cols-12 gap-16">
                    <div className="relative col-span-12 lg:col-span-6">
                        <div className="absolute w-40 h-40 bg-green-100 rounded-full -z-10 -top-8 -right-9"></div>
                        <figure className="h-[25rem] rounded bg-gray-200"><img src="" alt="img" /></figure>
                    </div>
